...
<div id="main">
	<div class="content">
		...
		$update = mysqli_query ($conn,"UPDATE  tbl_konsumen SET nama_konsumen='$nmpnp',almt_konsumen='$alamat',telepon='$nohp',umur='$umurpnp',jenis_kelamin='$jekelamin',tmp_lahir='$tlahir',tgl_lahir='$tgllahir',foto='".$_FILES["foto"]["name"]."' where no_identitas='$idpnp' ") or die (mysqli_error());
