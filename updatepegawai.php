...
<div id="main">
	<div class="content">
		...
		$update = mysqli_query ($conn,"UPDATE  tabel_pegawai SET nama_pegawai='$nmpgw',alamat_pegawai='$alamat',jenis_kelamin='$jkelamin',umur_pegawai='$umurpgw',telepon='$telepon',tmp_lahir='$tlahir',tgl_lahir='$tgllahir',foto='".$_FILES["foto"]["name"]."' where no_pegawai='$idpgw' ") or die (mysqli_error());
